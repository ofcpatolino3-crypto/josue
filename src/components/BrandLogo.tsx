  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col">
        ...
        <span
          className="text-[9px] sm:text-[10px] font-bold tracking-widest uppercase text-[#2563EB]"
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex flex-col leading-none">
        <span className="text-xl sm:text-2xl font-black tracking-wider text-[#FFFFFF] font-sans">
          PORTAL
        </span>
        <span className="text-[10px] sm:text-[11px] font-extrabold tracking-widest text-[#2563EB] mt-0.5">
          CONCURSOS E OAB
        </span>
      </div>
    </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <circle cx="250" cy="250" r="230" stroke="#FFFFFF" strokeWidth="36" />
          <circle cx="250" cy="250" r="140" stroke="#FFFFFF" strokeWidth="12" strokeDasharray="16 16" />
      ...
      >
        <div className="w-28 h-28 border-[10px] border-[#FFFFFF] rounded-full flex items-center justify-center">
          <div className="w-10 h-10 border-4 border-[#2563EB] rounded-sm rotate-45" />
        </div>
        <div className="flex flex-col">
          <span className="text-6xl lg:text-8xl font-black tracking-widest text-[#FFFFFF] uppercase font-sans">
            PORTAL
          </span>
          <span className="text-xl lg:text-3xl font-bold tracking-[0.3em] text-[#2563EB] uppercase">
            CONCURSOS E OAB
          </span>
        </div>
      </div>
