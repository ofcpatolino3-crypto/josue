...
export const MessagesView: React.FC<MessagesViewProps> = ({
  ...
  return (
    <div className="animate-fadeIn space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          <button
            ...
            className="flex items-center gap-1.5 bg-[#111D3E] hover:bg-[#1C2C55] text-[#94A3B8] hover:text-[#FFFFFF] border border-[#263B6E] px-3 py-2 rounded-lg text-xs font-semibold transition-colors cursor-pointer"
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-[#2563EB] hover:bg-[#3B82F6] text-[#0B132B] px-3.5 py-2 rounded-lg text-xs font-bold transition-all cursor-pointer shadow-sm"
          >
      ...
      <div className="bg-gradient-to-r from-[#111D3E] via-[#1A2E56] to-[#111D3E] border border-[#38BDF8]/40 rounded-xl p-3.5 sm:p-4 text-xs text-[#FFFFFF] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-sm text-[#FFFFFF] flex items-center gap-1.5">
              <span>🎙️ Roteiros de Áudio para Gravar no WhatsApp (20 a 35s)</span>
              <span className="bg-[#38BDF8] text-[#0B132B] text-[10px] font-extrabold px-1.5 py-0.5 rounded uppercase">
                3x Mais Conversão
              </span>
            </div>
        ...
        <button
          ...
          className="bg-[#38BDF8] hover:bg-[#2fb0ea] text-[#0B132B] text-xs font-bold px-3.5 py-1.5 rounded-lg shrink-0 transition-colors cursor-pointer flex items-center gap-1.5"
        >
      ...
      <div className="bg-[#111D3E] border border-[#263B6E] rounded-xl p-3 text-xs text-[#94A3B8] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5">
        ...
        <div className="flex flex-wrap gap-2">
          <code className="bg-[#0B132B] border border-[#263B6E] text-[#2563EB] px-2 py-0.5 rounded text-[11px] font-mono">
            {'{nome}'} (1º Nome)
          </code>
          <code className="bg-[#0B132B] border border-[#263B6E] text-[#2563EB] px-2 py-0.5 rounded text-[11px] font-mono">
            {'{nome_completo}'}
      ...
      {showAddForm && (
        <form
          ...
          className="bg-[#111D3E] border border-[#2563EB] rounded-xl p-4 sm:p-5 space-y-4 shadow-md"
        >
          <div className="flex items-center justify-between border-b border-[#263B6E] pb-2">
            <h3 className="font-bold text-sm text-[#2563EB] flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#0B132B] border border-[#263B6E] text-[#FFFFFF] rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#2563EB] cursor-pointer"
              >
          ...
          {newCategory === 'roteiro_audio' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-[#0B132B] p-3 rounded-lg border border-[#38BDF8]/30">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#111D3E] border border-[#263B6E] text-[#FFFFFF] rounded-lg px-3 py-1.5 text-xs focus:outline-none focus:border-[#38BDF8]"
                />
              </div>
              <div>
                <label className="block text-[10px] font-semibold uppercase tracking-wider text-[#38BDF8] mb-1 flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              <label className="block text-[10px] font-semibold uppercase tracking-wider text-[#2563EB] mb-1">
                ⚡ Gatilho Mental
              </label>
              <input
                type="text"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#0B132B] border border-[#263B6E] text-[#FFFFFF] placeholder-[#94A3B8]/60 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#2563EB] resize-y font-sans"
            />
          </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                activeCategory === cat.id
                  ? cat.id === 'roteiro_audio'
                    ? 'bg-[#38BDF8] text-[#0B132B] font-bold shadow-sm'
                    : 'bg-[#2563EB] text-[#0B132B] font-bold shadow-sm'
                  : 'bg-[#111D3E] text-[#94A3B8] hover:text-[#FFFFFF] border border-[#263B6E]'
              }`}
            >
              {cat.label}
            </button>
        ...
        <div className="relative min-w-[220px]">
          ...
          <input
            ...
            className="w-full bg-[#111D3E] border border-[#263B6E] text-[#FFFFFF] placeholder-[#94A3B8]/60 rounded-lg pl-9 pr-3 py-1.5 text-xs focus:outline-none focus:border-[#2563EB]"
          />
        </div>
      </div>
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((tmpl) => {
            ...
            return (
              <div
                key={tmpl.id}
                className={`bg-[#111D3E] border rounded-xl p-4 sm:p-5 transition-all shadow-sm flex flex-col gap-3 ${
                  isAudio ? 'border-[#38BDF8]/40 bg-gradient-to-br from-[#111D3E] to-[#121F38]' : 'border-[#263B6E]'
                }`}
              >
                {isEditing ? (
                  /* Edit Form Mode */
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div className="sm:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full bg-[#0B132B] border border-[#263B6E] text-[#FFFFFF] rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-[#2563EB]"
                        />
                      </div>
                      <div>
                        <label className="block text-[10px] font-semibold uppercase tracking-wider text-[#94A3B8] mb-1">
                        ...
                        <select
                          ...
                          className="w-full bg-[#0B132B] border border-[#263B6E] text-[#FFFFFF] rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-[#2563EB] cursor-pointer"
                        >
                          <option value="roteiro_audio">🎙️ Roteiro para Áudio (Voice Script)</option>
                          <option value="pos_prova">Pós-Prova</option>
                    ...
                    {editCategory === 'roteiro_audio' && (
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-[#0B132B] p-2.5 rounded-lg border border-[#38BDF8]/30">
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Ex: 25 a 30 segundos"
                            className="w-full bg-[#111D3E] border border-[#263B6E] text-[#FFFFFF] rounded-lg px-3 py-1 text-xs focus:outline-none focus:border-[#38BDF8]"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-semibold uppercase tracking-wider text-[#38BDF8] mb-1">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full bg-[#0B132B] border border-[#263B6E] text-[#FFFFFF] rounded-lg p-3 text-sm focus:outline-none focus:border-[#2563EB] resize-y font-sans"
                      />
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 bg-[#2563EB] hover:bg-[#3B82F6] text-[#0B132B] font-bold px-4 py-1.5 rounded-lg text-xs cursor-pointer"
                      >
                  ...
                  <>
                    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
                      <div>
                        <div className="flex items-center gap-2 flex-wrap mb-1">
                          ...
                          {tmpl.gatilho && (
                            <span className="inline-flex items-center gap-1 bg-[#0B132B] text-[#FFFFFF] border border-[#2563EB]/50 text-[11px] font-semibold px-2.5 py-0.5 rounded-md shadow-xs">
                              ⚡ {tmpl.gatilho}
                            </span>
                          )}
                        ...
                        <h3 className="font-serif font-bold text-base sm:text-lg text-[#FFFFFF] mt-1 flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2 self-start sm:self-center shrink-0">
                        <button
                          ...
                          className="flex items-center gap-1 text-xs text-[#94A3B8] hover:text-[#2563EB] bg-[#0B132B] border border-[#263B6E] px-2.5 py-1 rounded-lg transition-colors cursor-pointer"
                    ...
                    {isAudio && (
                      <div className="bg-[#0B132B] border border-[#38BDF8]/30 rounded-xl p-3 text-xs space-y-2">
                        ...
                        {tmpl.dicasGravacao && tmpl.dicasGravacao.length > 0 && (
                          <div className="pt-2 border-t border-[#263B6E] space-y-1">
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 text-[11px] text-[#FFFFFF]/90">
                              {tmpl.dicasGravacao.map((dica, idx) => (
                                <li key={idx} className="flex items-start gap-1.5 bg-[#111D3E]/70 p-1.5 rounded">
                    ...
                    {(tmpl.emocao || tmpl.logica) && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                        {tmpl.emocao && (
                          <div className="bg-[#0B132B]/70 border border-[#B14432]/30 rounded-lg p-2.5">
                            ...
                            <p className="text-[#FFFFFF]/90 leading-snug">{tmpl.emocao}</p>
                          </div>
                        )}
                        {tmpl.logica && (
                          <div className="bg-[#0B132B]/70 border border-[#5C7A9E]/40 rounded-lg p-2.5">
                            ...
                            <p className="text-[#FFFFFF]/90 leading-snug">{tmpl.logica}</p>
                          </div>
                        )}
                      </div>
                    )}
                    ...
                    <div
                      className={`rounded-lg p-4 text-xs sm:text-[14px] leading-relaxed whitespace-pre-wrap font-sans ${
                        isAudio
                          ? 'bg-[#0E1726] border-2 border-[#38BDF8]/40 text-[#FFFFFF] shadow-inner font-medium tracking-wide'
                          : 'bg-[#0B132B]/90 border border-[#263B6E] text-[#FFFFFF]'
                      }`}
                    >
                      {isAudio && (
                    ...
                    {/* Footer Actions */}
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pt-1 border-t border-[#263B6E]/50">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                          isCopied
                            ...
                            : isAudio
                            ? 'bg-[#38BDF8] hover:bg-[#2fb0ea] text-[#0B132B]'
